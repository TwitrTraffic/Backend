...
def trafficAllTime():
    if request.method == 'POST':
        source = [str(request.form['srcLat']), str(
            request.form['srcLng']), str(request.form['src'])]
        destination = [str(request.form['destLat']), str(
            request.form['destLng']), str(request.form['dest'])]
    ...
    # index '0'->lat ; '1'->long
    source = [request.json['srclat'], request.json[
...
# Sample API HIT: curl -i -H "Content-Type: application/json" -X POST -d
# '{"src":"mvit","srclat":"40.81381340000001","srclong":"-74.06693179999999","dest":"hebbal","destlat":"40.8145647","destlong":"-74.06878929999999","date":"2016-10-25","time":"13:32:12"}'
# http://localhost:5000/api/route/traffic/now
...
# Sample API HIT: curl -i -H "Content-Type: application/json" -X POST -d
# '{"src":"mvit","srclat":"40.81381340000001","srclong":"-74.06693179999999","dest":"hebbal","destlat":"40.8145647","destlong":"-74.06878929999999"}'
# http://localhost:5000/api/route/traffic/alltime
...
# Sample API HIT: curl -i -H "Content-Type: application/json" -X POST -d
# '{"src":"mvit","srclat":"40.81381340000001","srclong":"-74.06693179999999","dest":"hebbal","destlat":"40.8145647","destlong":"-74.06878929999999"}'
# http://localhost:5000/api/route/status/traffic/alltime
...
# Sample API HIT: curl -i -H "Content-Type: application/json" -X POST -d
# '{"src":"mvit","srclat":"40.81381340000001","srclong":"-74.06693179999999","dest":"hebbal","destlat":"40.8145647","destlong":"-74.06878929999999","date":"2016-10-25","time":"13:32:12"}'
# http://localhost:5000/api/route/status/traffic/now
...
# Sample API HIT: curl -i -H "Content-Type: application/json" -X POST -d
# '{"srclat":"40.81381340000001","srclong":"-74.06693179999999","destlat":"40.8145647","destlong":"-74.06878929999999"}'
# http://localhost:5000/api/checkpoints/locations
...
# Sample API HIT: curl -i -H "Content-Type: application/json" -X POST -d
# '{"srclat":"40.81381340000001","srclong":"-74.06693179999999","destlat":"40.8145647","destlong":"-74.06878929999999"}'
# http://localhost:5000/api/checkpoints/coordinates
